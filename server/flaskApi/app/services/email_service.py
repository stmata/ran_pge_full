...
class EmailService:
    ...
    def send_verification_email(self, email, verification_code, user_name):
    ...
    def send_contact_email(self, email, name, subject, content):
        #receiver_email = email
        #subject = 'Email Verification - SKEMA Business School'
    ...
    def generate_verification_code(length=6):
        ...
        # Génère un nombre aléatoire et le convertit en une chaîne de la longueur spécifiée
