    ...
    def traitement_pdf_pptx(self, data):
        ...
        try:
            ...
            if not level or not module or not title:
                return {"error": "Level, titre et module requis"}, 400
            ...
            if suffix == '.pdf':
                ...
                return {"error": "Format de fichier non pris en charge"}, 400
            ...
            if resultat_fonction:
                ...
                if rst.inserted_id:   
                    ...
                    return {"message": "Transcription sauvegardée dans Content"}, 200
                else:
