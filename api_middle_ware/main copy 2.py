    ...
    if user_input == "":
        ...
        try:
            ...
            if thought_topdown == "" and thought_bottomup == "":
                ...
                return {'response' : gpt_web_resp, 'sources':['Marketing Management, Kotler et. al. Sixteenth Edition', 'Marketing the basics, Karl Moore and Niketh Pareek @2006'], 'scores': [], 'chunks': ''}
